...
import {NzI18nService, NzInputNumberComponent} from 'ng-zorro-antd';
  ...
  ngAfterViewInit(): void {
    if (this.inputNumberComp) {
      this.inputNumberComp.onModelChange = (value: string) => {
        ...
        this.inputNumberComp.setValue(this.inputNumberComp.inputElement.nativeElement.value, true);
      };
    }
  }
